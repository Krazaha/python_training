...
class TestAddNew(unittest.TestCase):
    ...
    def test_add_new(self):
        ...
        self.add_new_creating(wd)
        self.logout(wd)

    def logout(self, wd):
        wd.find_element_by_link_text("Logout").click()

    def add_new_creating(self, wd):
        # fill firstname
        ...
        wd.find_element_by_name("nickname").send_keys("Ivani4")
        # fill company
        wd.find_element_by_name("company").click()
        wd.find_element_by_name("company").clear()
        wd.find_element_by_name("company").send_keys("Roga i kopita")
        # fill address
        ...
        wd.find_element_by_name("home").send_keys("912313123123")
        # fill mobile phone
        wd.find_element_by_name("mobile").click()
        wd.find_element_by_name("mobile").clear()
        wd.find_element_by_name("mobile").send_keys("231231241231")
        # fill email
        wd.find_element_by_name("email").click()
        wd.find_element_by_name("email").clear()
        wd.find_element_by_name("email").send_keys("asdasd@sdfasdasd")
        # fill birthday
